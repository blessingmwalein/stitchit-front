  ...
  <FullScreenLayout>
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      <div class="relative flex flex-col justify-center w-full h-screen lg:flex-row dark:bg-gray-900">
        ...
        <div class="relative hidden lg:block lg:w-1/2 h-screen">
          <img src="/images/logo/backdrop.jpg" alt="Backdrop" class="w-full h-full object-cover" />
          <div class="absolute bottom-4 left-0 right-0">
            <p class="text-center text-black-400 dark:text-white/60">
...
const handleSubmit = async () => {
  ...
  if (authStore.successMessage) {
    ...
    snackbar.add({
      type: "error",
      text: authStore.errorMessage ?? "An error occurred",
    });
  }
};
</script>
