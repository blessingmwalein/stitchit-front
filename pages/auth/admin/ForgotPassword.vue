<template>
    <FullScreenLayout>
      <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen lg:flex-row dark:bg-gray-900">
          ...
          <div class="relative items-center hidden w-full h-full lg:w-1/2  dark:bg-white/5 lg:grid">
            <div class="flex items-center justify-center z-1">
              <common-grid-shape />
              <div class="flex flex-col items-center max-w-xs">
                <router-link to="/" class="block mb-4">
                  <img width="{231}" height="{48}" src="/images/logo/STICHIT-01.png" alt="Logo" />
                </router-link>
                <p class="text-center text-gray-400 dark:text-white/60">
                  © 2025 Stitchit. All rights reserved.
                </p>
              </div>
            </div>
          </div>
  ...
  import CustomInputField from '@/components/forms/FormElements/CustomInputField.vue'
