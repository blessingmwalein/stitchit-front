                ...
                <div v-if="order?.id"
                    ...
                    <Tabs value="0">
                        ...
                        <TabPanels>
                            ...
                            <TabPanel value="0">
                                <div class="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
                                    <h4 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-4">Order Details
                                    </h4>
                            ...
                            <TabPanel value="2">
                                <div class="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
                                    <h4 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-4">Rug Information
                                    </h4>
                                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-7 2xl:gap-x-12">
                            ...
                            <TabPanel value="3" v-if="order?.is_order_ready">
                                <div v-if="product"
                                    ...
                                    <div
                                        ...
                                        <div class="flex-shrink-0 w-full md:w-1/2 p-2 flex justify-center items-center">
                                            <img v-if="product.default_image"
                                                :src="`${config.public.imageUrl}${product.default_image}`"
                                                alt="Product image"
                                    ...
                                    <!-- DATES & ACTIONS CARD -->
                                    <div
                                        class="w-full md:w-1/3 bg-white rounded-lg shadow dark:bg-gray-800 flex flex-col p-6">
                                        <!-- Dates Grid -->
                                        <div
