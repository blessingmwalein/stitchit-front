            ...
            <div v-if="order?.id"
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex gap-2 ">
                        <div>
                            <CustomButton v-if="isEditButtonVisible" @click="handleEditOrder(order)" label="Edit Order"
                                :prefixIcon="true" variant="brand" rounded="full">
                                <template #prefix>
                                    <div class="mr-3">
                        ...
                        <div>
                            <CustomButton v-if="isProcessButtonVisible" @click="handleProcessOrder(order)" label="Proccess"
                        ...
                        <div>
                            <CustomButton v-if="isStartProductionButtonVisible" @click="handleStartProduction(order)"
                                label="Start Production" variant="warning" rounded="full" :prefixIcon="true">
                                <template #prefix>
                                    <div class="mr-3">
                                        <ArrrowUTurnIcon :height="20" :width="20" />
                                    </div>
                        ...
                        <div>
                            <CustomButton v-if="isDeliverProduct" @click="handleDeliverOrder(order)" label="Deliver Product"
                                variant="success" rounded="full" :prefixIcon="true">
                                <template #prefix>
                                    <div class="mr-3">
                    ...
                    <TabPanels>
                            ...
                            <div class="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
                                ...
                                <div class="flex flex-col lg:flex-row gap-6 items-start">
                                    <div
                                        ...
                                        <img v-if="order?.image_url" :src="`${config.public.imageUrl}${order.image_url}`"
                                ...
                                <div class="mt-6">
                                    <h4 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-4">Color Palette
                                    </h4>
                        ...
                        <TabPanel value="1">
                            <div class="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6 relative">
                                ...
                                <h4 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-4">Client Information
                                </h4>
                                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-7 2xl:gap-x-12">
                        ...
                        <TabPanel value="2">
                            <div class="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
                                ...
                                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-7 2xl:gap-x-12">
                                    ...
                                    <InfoField label="Approx Cost" :value="formatCurrency(order?.rug?.approx_cost)" />
                            ...
                            <div v-if="product"
                                ...
                                <div
                                    ...
                                    <div class="flex-shrink-0 w-full md:w-1/2 p-2 flex justify-center items-center">
                                        <img v-if="product.default_image"
                                            :src="`${config.public.imageUrl}${product.default_image}`" alt="Product image"
                                    ...
                                    <div class="flex-auto p-6 flex flex-col">
                                        ...
                                        <div
                                            class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-gray-700 dark:text-gray-200 flex-grow">
                                ...
                                <div class="w-full md:w-1/3 bg-white rounded-lg shadow dark:bg-gray-800 flex flex-col p-6">
                                    <!-- Dates Grid -->
                                    <div
                                        class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-gray-700 dark:text-gray-200 flex-1">
                        ...
                        <TabPanel value="4" v-if="order?.is_order_ready">
                            <div
                                ...
                                <!-- Product Summary -->
                                <div class=" pt-4 ">
                                    <h5 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">Product Summary
                                    </h5>
                                ...
                                <div class="border-t pt-4 mt-6">
                                    <h5 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">Order Transactions
                                    </h5>
    
                                    <div v-if="order?.transactions && order?.transactions.length" class="overflow-x-auto">
                                        <table
                                          ...
                                          'bg-gray-100 text-gray-700': !['completed', 'pending', 'failed'].includes(tx.status)
                                                    ...
                                                    <!-- Amount -->
                                                    <td class="py-2 px-4">{{ formatCurrency(tx.amount) }} {{ tx.currency }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
...
const isEditButtonVisible = computed(() => {
  return orderStore.selectedOrder?.status === 'Pending';
});
...
const isStartProductionButtonVisible = computed(() => {
  return orderStore.selectedOrder?.status === 'Processing';
});

const isDeliverProduct = computed(() => {
  return orderStore.selectedOrder?.status !== 'Delivered' && orderStore.selectedOrder?.is_order_ready;
});
