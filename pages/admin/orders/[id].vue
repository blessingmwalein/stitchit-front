                ...
                <TabPanels>
                        ...
                        <div v-if="product"
                            ...
                            <div
                                ...
                                <div class="flex-auto p-6 flex flex-col">
                                    ...
                                    <div class="mt-6">
                                        <h4 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-4">Rug Colors
                                        </h4>
                    ...
                    <TabPanel value="4" v-if="order?.is_order_ready">
                        <div
                            ...
                            <!-- Product Summary -->
                            <div class=" pt-4 ">
                                <h5 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">Product Summary</h5>
                            ...
                            <div class="border-t pt-4 mt-6">
                                <h5 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">Order Transactions</h5>
                                ...
                                <div v-if="order?.transactions && order?.transactions.length" class="overflow-x-auto">
                                    <table
                                        ...
                                        <tbody>
                                            <tr v-for="tx in order?.transactions" :key="tx.id"
                                                ...
                                                <td class="py-2 px-4 whitespace-nowrap">{{ formatDateString(tx.created_at)
                                                    }}</td>
                                  ...
                                  'bg-gray-100 text-gray-700': !['completed', 'pending', 'failed'].includes(tx.status)
                                                ...
                                                <!-- Amount -->
                                                <td class="py-2 px-4">{{ formatCurrency(tx.amount) }} {{ tx.currency }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
