<template>
  <aside :class="[
    ...
    <div :class="[
      ...
      <!-- Logo and branding -->
      <router-link to="/">
        <img v-if="isExpanded || isHovered || isMobileOpen" class="dark:hidden" src="/images/logo/STICHIT-01.png" alt="Logo"
          width="150" height="40" />
        <img v-if="isExpanded || isHovered || isMobileOpen" class="hidden dark:block" src="/images/logo/STICHIT-01.png"
          alt="Logo" width="150" height="40" />
        <img v-else src="/images/logo/STICHIT-01.png" alt="Logo" width="32" height="32" />
      </router-link>
    </div>
    ...
    items: [
      {
        ...
        subItems: [
          ...
          { name: "Create User", path: "/admin/users/create", pro: false },
        ],
      },
      {
        icon: LockIcon,
        ...
        subItems: [
          { name: "Roles", path: "/alerts", pro: false },
          { name: "Permissions", path: "/avatars", pro: false },
        ],
      },
