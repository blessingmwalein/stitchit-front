<template>
  <Modal v-if="isViewOrderModal" @close="closeModal()" width="max-w-6xl">
    <!-- Header -->
    <template #header>
      ...
      <div class="no-scrollbar relative w-full overflow-y-auto bg-white dark:bg-gray-900">
        ...
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6 relative">
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-7 2xl:gap-x-12">
            ...
            <InfoField label="Client Address" :value="order?.address" />
            <InfoField label="Client City" :value="order?.city" />
        ...
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-7 2xl:gap-x-12">
            ...
            <InfoField label="Approx Production Cost" :value="formatCurrency(order?.rug?.approx_production_cost)" />
          </div>
        </div>
        ...
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
          ...
          <div class="flex flex-col lg:flex-row gap-6 items-start">
            ...
            <!-- Image -->
            <div
              class="flex-shrink-0 w-full lg:w-1/4 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-800 max-h-[250px]">
        ...
        <!-- Dates -->
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
          <h4 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-4">Dates</h4>
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-7 2xl:gap-x-12">
            <InfoField label="Delivery Date" :value="formatDateString(order?.delivery_date) ?? 'N/A'" />
            <InfoField label="Order Created At" :value="formatDateString(order?.created_at)" />
            <InfoField label="Last Updated At" :value="formatDateString(order?.updated_at)" />
          </div>
        </div>
